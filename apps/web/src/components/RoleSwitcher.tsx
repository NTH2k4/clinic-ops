...
export function RoleSwitcher() {
  ...
  return (
    <select
      ...
      className="h-11 max-w-32 rounded-md border border-border bg-surface px-2 text-sm font-medium text-text transition-colors hover:border-border-strong hover:bg-surface-muted"
