...
- Thêm `prisma:seed:demo-auth` và gọi trong Render `buildCommand` sau migrations để repair demo login users/password hashes idempotently; bug này được phát hiện khi Render health pass nhưng login smoke trả `401`.
