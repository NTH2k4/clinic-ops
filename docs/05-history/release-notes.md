...
- Final local rerun on 2026-08-28 also confirmed OpenAPI JSON parse, `git diff --check`, and API-mode teardown cleanup with `0` generated `@example.test` users remaining.
