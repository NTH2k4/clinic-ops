...
| CR-012 | 2026-08-27 | Chốt hướng MVP Release Completion trước khi mở feature mới: tích hợp authorization hardening, chạy full verification, cập nhật docs và chuẩn bị deploy bằng subagent-driven. | approved | Người dùng duyệt toàn bộ tài liệu một lượt trước khi agent triển khai plan trong phiên hiện tại. |
